...
Identify and extract repeated UI patterns into reusable widgets. This reduces code duplication, ensures consistency across the app, and makes UI updates easier by providing a single source of truth for common patterns.
...
**Branch naming**: `refactor/03-common-widgets`
