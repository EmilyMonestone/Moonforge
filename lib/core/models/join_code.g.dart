...
_JoinCode _$JoinCodeFromJson(Map<String, dynamic> json) => _JoinCode(
  ...
  ttl: const TimestampConverter().fromJson(json['ttl']),
);
...
Map<String, dynamic> _$JoinCodeToJson(_JoinCode instance) => <String, dynamic>{
  ...
  'ttl': const TimestampConverter().toJson(instance.ttl),
};
...
class JoinCodePatchBuilder<$$T extends JoinCode?>
  ...
  late final PatchBuilder<DateTime?, Object?> ttl = PatchBuilder(
...
class JoinCodeFilterBuilder extends FilterBuilderNode {
  ...
  /// Filter by sid
  late final ComparableFilterField<String> sid = ComparableFilterField<String>(
    field: path.append('sid'),
    toJson: (value) => (value as String),
  );
  ...
  /// Filter by ttl
  late final FilterField<DateTime?, Object?> ttl =
      FilterField<DateTime?, Object?>(
        field: path.append('ttl'),
        toJson: (value) => const TimestampConverter().toJson(value),
      );
