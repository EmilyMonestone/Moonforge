...
class Campaigns extends Table {
  TextColumn get id => text().clientDefault(() => uuid.v8())();
...
class Entities extends Table {
  ...
  TextColumn get originType => text().withDefault(
    const Constant('campaign'),
  )(); // new default ensures migration success
  TextColumn get originId => text()(); // campaign/chapter/adventure/scene id
  TextColumn get summary => text().nullable()();
...
class Players extends Table {
  ...
  TextColumn get ddbCharacterId =>
      text().nullable()(); // D&D Beyond character ID
  DateTimeColumn get lastDdbSync =>
      dateTime().nullable()(); // Last sync from D&D Beyond
...
class OutboxEntries extends Table {
  TextColumn get id => text().clientDefault(() => uuid.v8())(); // uuid
