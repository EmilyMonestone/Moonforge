...
@DocumentIdField() String get id;// the short code
 String get cid; String? get sid; DateTime? get createdAt; DateTime? get ttl;
...
@useResult
$Res call({
@DocumentIdField() String id, String cid, String? sid, DateTime? createdAt, DateTime? ttl
});
...
/// Create a copy of JoinCode
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? cid = null,Object? sid = freezed,Object? createdAt = freezed,Object? ttl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@DocumentIdField()  String id,  String cid,  String? sid,  DateTime? createdAt,  DateTime? ttl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JoinCode() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@DocumentIdField()  String id,  String cid,  String? sid,  DateTime? createdAt,  DateTime? ttl)  $default,) {final _that = this;
switch (_that) {
case _JoinCode():
return $default(_that.id,_that.cid,_that.sid,_that.createdAt,_that.ttl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@DocumentIdField()  String id,  String cid,  String? sid,  DateTime? createdAt,  DateTime? ttl)?  $default,) {final _that = this;
switch (_that) {
case _JoinCode() when $default != null:
return $default(_that.id,_that.cid,_that.sid,_that.createdAt,_that.ttl);case _:
  return null;
...
class _JoinCode implements JoinCode {
  const _JoinCode({@DocumentIdField() required this.id, required this.cid, this.sid, this.createdAt, this.ttl});
...
/// Create a copy of JoinCode
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? cid = null,Object? sid = freezed,Object? createdAt = freezed,Object? ttl = freezed,}) {
