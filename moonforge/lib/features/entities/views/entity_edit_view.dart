...
class EntityEditView extends StatefulWidget {
  const EntityEditView({super.key, required this.entityId});

  final String entityId;

  @override
  State<EntityEditView> createState() => _EntityEditViewState();
}

class _EntityEditViewState extends State<EntityEditView> {
