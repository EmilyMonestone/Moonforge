...
class EntityEditScreenImpl extends StatefulWidget {
  const EntityEditScreenImpl({
    super.key,
  ...
  @override
  State<EntityEditScreenImpl> createState() => _EntityEditScreenImplState();
}

class _EntityEditScreenImplState extends State<EntityEditScreenImpl> {
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () {
                ...
                if (key.isNotEmpty) {
                  setState(() {
                    _statblockControllers[key] = TextEditingController(text: value);
                  });
                }
                Navigator.of(context).pop();
              },
          ...
          children: [
            ...
            if (_statblockControllers.isEmpty)
              Container(
                ...
                child: const Text('No stat block fields. Click + to add fields.'),
              )
            else
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  QuillToolbar(controller: _contentController),
