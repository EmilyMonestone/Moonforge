...
class CampaignSettingsView extends StatefulWidget {
  const CampaignSettingsView({super.key});

  @override
  State<CampaignSettingsView> createState() => _CampaignSettingsViewState();
}

class _CampaignSettingsViewState extends State<CampaignSettingsView> {
