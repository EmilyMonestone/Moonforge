...
class CampaignEditView extends StatefulWidget {
  const CampaignEditView({super.key});

  @override
  State<CampaignEditView> createState() => _CampaignEditViewState();
}

class _CampaignEditViewState extends State<CampaignEditView> {
