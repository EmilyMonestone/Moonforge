...
class CampaignMembersView extends StatefulWidget {
  const CampaignMembersView({super.key});

  @override
  State<CampaignMembersView> createState() => _CampaignMembersViewState();
}

class _CampaignMembersViewState extends State<CampaignMembersView> {
  @override
