...
class PartyService extends BaseService {
  ...
  @override
  String get serviceName => 'PartyService';
  ...
  Future<PartyStatistics> getPartyStatistics(String partyId) async {
    ...
    }, operationName: 'getPartyStatistics');
  }
  ...
  Future<Map<String, int>> getPartyComposition(String partyId) async {
    return execute(() async {
      ...
      return composition;
    }, operationName: 'getPartyComposition');
  }
  ...
  Future<PartyBalanceCheck> checkPartyBalance(String partyId) async {
    ...
    }, operationName: 'checkPartyBalance');
  }
}
