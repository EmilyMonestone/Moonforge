...
class SessionCalendarView extends StatefulWidget {
  const SessionCalendarView({super.key, required this.partyId});

  final String partyId;

  @override
  State<SessionCalendarView> createState() => _SessionCalendarViewState();
}

class _SessionCalendarViewState extends State<SessionCalendarView> {
