...
class AdventureEditView extends StatefulWidget {
  const AdventureEditView({
    super.key,
  ...
  @override
  State<AdventureEditView> createState() => _AdventureEditViewState();
}

class _AdventureEditViewState extends State<AdventureEditView> {
