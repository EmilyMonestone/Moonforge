...
class AutoUpdaterService {
  ...
  static const String _feedURLBase =
      'https://raw.githubusercontent.com/EmilyMoonstone/Moonforge/main/appcast';
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      logger.i(
        'App environment: $_appEnv (${isBeta ? "beta" : "production"} channel)',
      );
      ...
      logger.e(
        'Failed to initialize AutoUpdater',
        error: e,
